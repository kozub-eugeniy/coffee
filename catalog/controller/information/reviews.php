...
class ControllerInformationReviews extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('information/reviews/success'));
		}
		...
		$data['action'] = $this->url->link('information/reviews', '', true);
		...
		// Captcha
		if ($this->config->get($this->config->get('config_captcha') . '_status') && in_array('about', (array)$this->config->get('config_captcha_page'))) {
