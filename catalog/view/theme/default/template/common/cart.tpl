<div id="cart" style="display: block;float: left;margin: 0">
  <!--<button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn-inverse cart-btn dropdown-toggle">-->
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="cart-btn dropdown-toggle" title="Корзина">
    <!--<i class="fa fa-shopping-cart"></i> <span id="cart-total"><?php echo $text_items; ?></span>-->
    <span id="cart-total" class="cart-counter"><?php echo $text_count; ?></span>
  </button>
